...
function frameNum = dropcode2frame5994(timecode)

% calculate frames per time using dropcode
framesInOneSec  = 60;                   % 60     (for 59.94)
framesInOneMin  = framesInOneSec*60-4;  % 3596   (for 59.94)
framesInTenMin  = 10*framesInOneMin+4;  % 35964  (for 59.94)
framesInOneHour = 6*framesInTenMin;     % 215784 (for 59.94)
